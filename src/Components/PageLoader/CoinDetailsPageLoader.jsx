...
const CoinDetailsPageLoader = () => (
  ...
  >
    ...
    <rect x="5" y="300" rx="4" ry="4" width="96%" height="10" /> 
    <rect x="5" y="325" rx="4" ry="4" width="96%" height="10" /> 
    <rect x="5" y="350" rx="4" ry="4" width="96%" height="10" /> 
    <rect x="5" y="400" rx="8" ry="8" width="96%" height="100" /> 
  </ContentLoader>
);
